...
# Enable xterm-keys to support extended key sequences
set -g xterm-keys on
...
tmux_sessionizer="~/Documents/Development/dotfiles/tmux/tools/prime/tmux-sessionizer.sh"
tmux_sshonizer_agen="~/Documents/Development/dotfiles/tmux/tools/linkarzu/tmux-sshonizer-agen.sh"
ssh_select="~/Documents/Development/dotfiles/tmux/tools/linkarzu/ssh-select.sh"
# Script below goes through you `~/.ssh/config` file and shows the hosts in an fzf menu
ssh_config_select="~/Documents/Development/dotfiles/tmux/tools/linkarzu/ssh_config_select.sh"
...
unbind C-d
bind-key -r C-d run-shell "$tmux_sessionizer ~/Documents/Development/dotfiles/"
unbind C-i
bind-key -r C-i run-shell "$tmux_sessionizer ~/Documents/Studia/Python/"
unbind 2
bind-key -r 2 run-shell "$tmux_sessionizer ~/Documents/Studia/Algorytmy2/Laboratorium/"
unbind 3
bind-key -r 3 run-shell "$tmux_sessionizer ~/Documents/Studia/Python/Laboratorium/"
unbind 4
bind-key -r 4 run-shell "$tmux_sessionizer ~/Documents/Studia/MetodyNumeryczne1/Laboratorium/"
unbind 5
bind-key -r 5 run-shell "$tmux_sessionizer ~/Documents/Development/Kolo/"
...
unbind 1
bind-key -r 1 run-shell "$tmux_sessionizer ~/Documents/Studia/"
